                    ...
                    <div class="col-md-4">
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <p class="card-text">penyakit sistem pernapasan yang disebabkan oleh infeksi bakteri <i>Mycobacterium tuberculosis.</i></p>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Tuberkulosis tulang, juga dikenal sebagai TB skeletal,
                                        adalah tuberkulosis yang mempengaruhi tulang dan sendi yang disebabkan oleh bakteri <i>Mycobacterium tuberculosis</i></p>
                                    <p class="card-text"><strong>Gejala:</strong></p>
                                    <ul>
                                        <li>Hilang nafsu makan</li>
                                        <li>Penurunan berat badan</li>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">tuberkulosis yang menyerang kulit. Skrofuloderma termasuk dalam penyakit infeksi kulit
                                        langka yang disebabkan oleh bakteri <i>Mycobacterium tuberculosis</i> dan <i>Mycobacterium atypical.</i></p>
                                    <p class="card-text"><strong>Gejala:</strong></p>
                                    <ul>
                                        <li>Hilang nafsu makan</li>
                                        <li>Penurunan berat badan</li>
